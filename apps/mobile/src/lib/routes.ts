...
export const ROUTES = {
  ...
  columnRename: (id: string) => `/column/${id}/rename` as const,
  columnColor: (id: string) => `/column/${id}/color` as const,
...
export const SCREENS = {
  ...
  columnRename: "column/[id]/rename",
  columnColor: "column/[id]/color",
